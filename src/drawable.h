...
protected:
    ...
    GLuint bufJointIDs;     // A VBO that we use to store the joint IDs that influence a certain vertex
    GLuint bufJointWeights; // A VBO that we use to store the joint weights on a certain vertex
